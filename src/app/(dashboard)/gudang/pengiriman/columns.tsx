  ...
  },
  {
    ...
    accessorFn: (row) =>
      row.tanggal_penjualan
        ? format(new Date(row.tanggal_penjualan), "dd MMMM yyyy", {
            locale: id,
          })
        : "",
    cell: ({ row }) => {
  ...
  },
  {
    ...
    accessorFn: (row) =>
      row.pembayaran?.tanggal_pembayaran
        ? format(new Date(row.pembayaran?.tanggal_pembayaran), "dd MMMM yyyy", {
            locale: id,
          })
        : "",
    cell: ({ row }) => {
      ...
      return (
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="flex flex-col">
            ...
            <Link
              href={`/gudang/pengiriman/new/${row.original.id_penjualan}`}
