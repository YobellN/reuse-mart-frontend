...
export function LaporanTransaksiPenitipDownloadButton({ data }: { data: PenitipTransaksiLaporanSchema }) {
  ...
  return (
    <Button
      ...
      title={isDataEmpty ? "Tidak ada data untuk diunduh" : "Unduh laporan"}
    >
      <Printer className="w-4 h-4 mr-2" />
      {isDataEmpty ? "Data Kosong" : "Unduh Laporan"}
    </Button>
  );
}
