...
import { handleRegisterOrganisasi } from "@/services/auth/user-services"
...
const registerScheme = z.object({
    ...
    no_sk: z.string().trim().nonempty({ message: "Nomor SK tidak boleh kosong" }).min(4, { message: "Nomor SK minimal 4 karakter" }),
    jenis_organisasi: z.string().trim().nonempty({ message: "Jenis organisasi tidak boleh kosong" }),
    alamat_organisasi: z.string().trim().nonempty({ message: "Alamat organisasi tidak boleh kosong" }),
...
export function RegisterOrganisasiForm({
    className,
    ...props
    ...
    const onSubmit = async (data: FormScheme) => {
        ...
        formData.append("jenis_organisasi", data.jenis_organisasi);
                                    ...
                                    <FormField
                                        ...
                                        render={({ field }) => (
                                            <FormItem className="w-full">
                                                ...
                                                <FormControl>
                                                    <Input placeholder="Masukkan nomor SK organisasi" {...field} />
                                                </FormControl>
                                                <FormMessage />
                                            </FormItem>
                                        )}
