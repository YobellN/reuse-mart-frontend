...
export const OrganisasiSchema = z.object({
    ...
    jenis_organisasi: z.string().nonempty({ message: "Jenis organisasi tidak boleh kosong" }),
    alamat_organisasi: z.string().nonempty({ message: "Alamat organisasi tidak boleh kosong" }),
});
